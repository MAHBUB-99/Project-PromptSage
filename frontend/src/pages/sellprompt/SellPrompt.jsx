...
function SellPrompt() {
    ...
    return (
        <div className='h-screen bg-slate-900 '>
            <Navbar />
            <div className=' w-screen mt-4 ml-40'>
                ...
                <input
                    ...
                    className='h-10 w-5/12 text-sm bg-slate-800 border-2 rounded-lg  
                ...
                <textarea
                    ...
                    className='h-22 w-5/12  text-sm  bg-slate-800 border-2 rounded-lg  
                    border-white border-opacity-50 outline-none focus:border-white
                    focus:text-white transition duration-200 ease-in-out drop-shadow-2xl
                '/>

                <label for="type" className="block mt-2 mb-2 text-sm font-medium text-white">Prompt Type</label>
                <select id="price" class="w-5/12 bg-slate-800 border border-gray-300 text-white text-sm rounded-lg focus:border-white block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white  dark:focus:border-white">
                ...
                <button class=" flex items-center justify-center p-0.5  mt-2 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-amber-500 to-rose-600 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
