    ...
    <div className=' bg-slate-900 '>
      ...
      <div className="flex flex-col items-center mt-5">
          ...
          <div className="grid grid-cols-5 gap-4">
            {samplePrompts.map((prompt) => (
              <div key={prompt.id} className="relative group">
                <div
                  style={{
                    backgroundImage: 'url("https://img.freepik.com/premium-photo/black-phoenix-bird-with-yellow-face-black-background_890191-2490.jpg")',
                  }}
        ...
        <section className="w-full text-white max-w-xl md:max-w-2xl lg:max-w-3xl xl:max-w-4xl 2xl:max-w-5xl mb-8">
          ...
          <div className="grid grid-cols-5 gap-4">
            {sample_midjourney_Engineers.map((engineer) => (
              <div key={engineer.id} className="relative group">
                <div
                  style={{
        ...
        <section className="w-full text-white max-w-xl md:max-w-2xl lg:max-w-3xl xl:max-w-4xl 2xl:max-w-5xl mb-8">
          ...
          <div className="grid grid-cols-5 gap-4">
            {sample_stable_diffusion_Engineers.map((engineer) => (
              <div key={engineer.id} className="relative group">
                <div
                  style={{
